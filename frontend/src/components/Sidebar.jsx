...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200 min-h-[calc(100vh-73px)] p-4 flex flex-col justify-between hidden md:flex shadow-sm">
      <div className="space-y-2">
        <span className="text-[10px] uppercase font-bold text-slate-400 tracking-widest pl-3 block mb-4">
          Navigation Menu
        </span>
      ...
      <div className="p-3 bg-slate-50 border border-slate-200/80 rounded-2xl">
        <p className="text-[11px] font-semibold text-slate-700">DevPilot Sandbox Mode</p>
        <span className="text-[10px] block text-slate-500 mt-1">SQLite & MongoDB Connected</span>
      </div>
    </aside>
  );
};
